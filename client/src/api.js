...
export const api = {
  ...
  createSeason: (name, host_id) => request('/api/admin/seasons', { method: 'POST', body: { name, ...(host_id ? { host_id } : {}) } }),
  presentSeason: (id) => request(`/api/admin/seasons/${id}/present`, { method: 'POST' }),
